...
```r
ors$down()
#> ℹ Taking down container ors-app-9c12bcc...
#> Warning: No resource found to remove for project "ors-app-9c12bcc".
#> ✖ Cannot take down container ors-app-9c12bcc. [330ms]
```
...
#> services:
#>   ors-app:
#>     container_name: ors-app-9c12bcc
#>     ports:
#>       - 18225:8080
#>       - 13260:9001
