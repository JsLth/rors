...
```r
ors$down()
#> ℹ Taking down container ors-app-6eea399...
#> Warning: No resource found to remove for project "ors-app-6eea399".
#> ✖ Cannot take down container ors-app-6eea399. [292ms]
```
...
#>       - ./docker/data/geofabrik_monaco-latest.osm.pbf:/home/ors/ors-core/data/osm_file.pbf
#>     environment:
#>       - BUILD_GRAPHS=False
